...
@section('content')
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-gray-800 shadow-lg rounded-b-2xl p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <form method="POST" action="{{ route('teller.abrirCaja', ['sucursal' => 1]) }}" class="md:col-span-2">
                        @csrf
    ...
    <script>
        function setMonto(event) {
            ...
            if (!monto || monto <= 0) {
                document.querySelector('#mensaje p').textContent = 'Por favor ingrese un monto mayor a 0.';
                return;
            }
